...
const Watch = () => {
    ...
    return (
        ...
        items-center gap-10 bg-black bg-opacity-70'>
                <ArrowLeftIcon onClick={() => router.push('/')} className='text-white ml-4 w-4 md:w-8 lg:w-12 cursor-pointer hover:opacity-70 transition duration-0 hover:duration-700' />
